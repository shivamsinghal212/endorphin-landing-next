...
export const CLUB_CITY_PAGES: ClubCityPage[] = [
  {
    ...
    region: 'Delhi',
    intro:
      'Delhi runs at dawn. Before the traffic thickens and the haze settles in, the Lodhi Gardens loop, the Nehru Park warm-up circle, and the Rajpath/Kartavya Path straights fill up with runners chasing a tempo or just a flat 5K. Endorfin lists every active run club in Delhi — social groups, marathon training squads, and trail collectives heading out to the Aravalli ridge on weekends. Browse the directory below, see who runs your pace, and show up at the next session.',
  ...
  },
  {
    ...
    intro:
      'Gurgaon — Gurugram on the map — runs hard. Cyber Hub runners start before the corporate towers wake up, Aravalli Biodiversity Park hosts trail loops on Saturdays, and the Leisure Valley track is where most of the city does its weekday speed work. Endorfin lists every active run club in Gurgaon: marathon training groups, casual social groups, and trail collectives. Find your pace below, RSVP to the next club run, and turn solo kilometres into a weekly habit with people who show up.',
  ...
  },
  {
    ...
    region: 'Maharashtra',
    intro:
      'Mumbai runs on its coastline. Marine Drive at 5:30am, Bandra Bandstand loops, the Carter Road promenade, and the Worli sea-face stretch — the city has more good running routes than any other in India, and a run club on almost every one. Endorfin lists every active club in Mumbai, Navi Mumbai, and Thane: TMM training squads, suburban social groups, and trail clubs heading to Yeoor and SGNP on weekends. Browse below and find the one closest to your pace.',
  ...
  },
  {
    ...
    region: 'Karnataka',
    intro:
      'Bengaluru\'s weather makes it India\'s most consistent running city — sub-25°C mornings almost year-round and Cubbon Park, Lalbagh, and Sankey Tank loops within walking distance of every other neighbourhood. Endorfin lists every active run club in Bengaluru: marathon training groups, MG Road tempo runners, Whitefield and Koramangala clubs, and the trail collectives that head out to Nandi Hills and Skandagiri on weekends. Find a club that runs your distance below.',
  ...
  },
  {
    ...
    region: 'Telangana',
    intro:
      'Hyderabad runs around water and rocks. The Necklace Road loop circles Hussain Sagar, KBR Park has the city\'s most-used 2.5K trail, and Durgam Cheruvu and the Botanical Gardens host the city\'s biggest training groups. Endorfin lists every active run club in Hyderabad and Secunderabad: Hyderabad Runners chapters, Jubilee Hills social groups, Gachibowli tech-park squads, and weekend long-run groups. Browse below and join a club that meets near your neighbourhood.',
  ...
  },
  {
    ...
    region: 'Tamil Nadu',
    intro:
      'Chennai runs by the sea. Marina Beach pre-dawn, Besant Nagar/Elliot\'s Beach loops, and the ECR stretch toward Mahabalipuram for long runs — the city has a quiet but committed running scene that comes out before the heat. Endorfin lists every active run club in Chennai: Chennai Runners chapters, Adyar and Anna Nagar runners, marathon training groups prepping for the Chennai Marathon, and weekend long-run squads. Browse below and find a club at your pace.',
