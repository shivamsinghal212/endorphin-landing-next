  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-sm text-muted-foreground font-body mb-10">Last updated: July 22, 2026</p>
        ...
        <div className="space-y-8 font-body text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p>Endorfin provides a platform to discover running events, RSVP to them, connect with other runners, record and track your runs (route, distance, pace, and related metrics), and — optionally — sync those runs to your device&apos;s health platform. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You agree to notify us immediately of any unauthorized use of your account.</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">4. Health, Fitness &amp; Physical Activity</h2>
            <p className="mb-3">Endorfin&apos;s run tracking and any training suggestions (including those from Kip, our AI Coach) are provided for general informational and fitness purposes only and are <span className="text-foreground/80">not medical advice</span>. Endorfin is not a medical device.</p>
            <p>Running and physical exercise carry inherent risks. You should consult a qualified physician before beginning or changing any exercise program, and you participate in any activity tracked through the App entirely at your own risk. GPS- and sensor-derived metrics — distance, pace, route, elevation, cadence, and calories — are estimates and may be inaccurate; you should not rely on them for medical, safety, or competitive purposes. Always stay aware of your surroundings and traffic while using the App outdoors.</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">5. User Conduct</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">6. Event Listings, Registration &amp; Payments</h2>
            ...
            <p className="mt-3">For events hosted directly on Endorfin (source &ldquo;Organiser&rdquo;), you register and pay <span className="text-foreground/80">within the App</span>. Payments are processed by our payment gateway, <span className="text-foreground/80">Razorpay</span>; by completing a paid registration you also agree to Razorpay&apos;s applicable terms. A completed registration is a <span className="text-foreground/80">personal, non-transferable</span> entry to the event for the ticket or category you selected, subject to the organizer&apos;s event rules.</p>
            <p className="mt-3"><span className="text-foreground/80">Cancellations and refunds.</span> Refund eligibility for Endorfin-hosted events is set per event and shown to you at the time of registration. Where a refund window is offered, cancellations made before the stated deadline are refunded to your original payment method (less any non-refundable processing fees); no refund is due for cancellations after that deadline or for no-shows. If an event is cancelled or materially rescheduled by the organizer, the organizer&apos;s stated refund policy for that event applies. To request a cancellation or refund, use the App or contact us at <a href="mailto:hello@endorfin.run" className="text-accent hover:underline">hello@endorfin.run</a>.</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">7. Account Termination</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">8. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">9. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">10. Dispute Resolution</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">11. Governing Law</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">12. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-semibold uppercase text-foreground mb-3">13. Contact Us</h2>
