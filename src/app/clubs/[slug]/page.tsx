  ...
  return (
    <header className="masthead">
      <div className="masthead-left">
        {/* Matches src/components/Logo.tsx exactly — red circle-mark icon
            rotating 120° on hover + Clash Display wordmark. */}
        <a href="/" className="flex items-center gap-2.5 group">
          <span className="text-signal transition-transform duration-300 group-hover:rotate-[120deg]">
            <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" className="w-7 h-7">
          ...
          <span className="font-logo font-semibold text-[22px] text-jet tracking-tight">
            endorfin
          </span>
        </a>
