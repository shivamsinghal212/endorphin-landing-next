...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://endorfin.run/' },
  openGraph: {
    type: 'website',
    url: 'https://endorfin.run/',
